...
def generateCoordinates(imageDimensions, divisions, margins, objectDimensions):
    ...
    divisions_h = divisions['horizontal']
    divisions_v = divisions['vertical']

    margin_top = margins['top']
    margin_bot = margins['bottom']
    ...
    # OBJECT LEVEL
    obj_width = objectDimensions['width']
    obj_height = objectDimensions['height']
...
print(generateCoordinates({'width': 1280, 'height': 768}, {'vertical': 4, 'horizontal': 3}, {'top': 25, 'right': 25, 'bottom': 25, 'left': 25}, {'width': 75, 'height': 75}))